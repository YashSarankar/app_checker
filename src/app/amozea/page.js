...
import { Sparkles, Image as ImageIcon, Smartphone, Zap, Palette, Layers, Download, ChevronRight } from 'lucide-react'
            ...
            <nav className="fixed top-0 w-full z-50 backdrop-blur-xl bg-black/50 border-b border-white/5">
                <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
                        ...
                        <a href="#preview" className="hover:text-white transition-colors">Showcase</a>
                        <a href="https://sarankar.com" className="hover:text-white transition-colors">More Apps</a>
                    </div>
                    <a
            ...
            <footer className="py-16 bg-black">
                <div className="max-w-6xl mx-auto px-6 flex flex-col items-center">
                    ...
                    <div className="flex gap-8 mb-10 text-slate-500 text-sm font-medium">
                        ...
                        <a href="https://sarankar.com" className="hover:text-white transition-colors">About</a>
                    </div>
